...
1. 📥 Clone this repository: `https://github.com/AkashKompelly/Responsive_Dashbord.git`
2. 📂 Navigate to the project directory: `cd Responsive_Dashbord`
3. 🌐 Open the `index.html` file in your preferred web browser.

## 🚀 Deployment

The portfolio is deployed on Netlify. Visit the live version [here](https://your-portfolio.netlify.app/). 🌟
